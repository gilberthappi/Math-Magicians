const Home = () => (
  <section className="hero">
    ...
    <p>
      ...
      often involving mental calculations and mathematical principles.
      Using quick calculations,
      sleight of hand, and a deep understanding of mathematics, 
      they create the illusion of performing seemingly impossible feats with numbers, 
      captivating audiences with their mathematical prowess and skill.
      Math magicians may perform in various settings,
      from stage shows to educational events,
